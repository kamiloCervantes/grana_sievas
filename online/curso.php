...
<div id="block_title">
<h3 class="dotted_line" style="font-size: 18px; color: #888;">Capacitación</h3>
</div>

<div class="navigation1">

            <ul>
                <li><a href="#" title="">Evaluador Interno</a></li>
				<li><a href="#" title="">Evaluador Interno</a></li>
				<li><a href="#" title="">Instituciones</a></li>
				<li><a href="#" title="">Profesores</a></li>
			</ul>
        </div>
