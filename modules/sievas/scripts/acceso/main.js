...
acceso.init = function(){
    ...
    if(acceso.loadPageVar('evaluacion') > 0){
        ...
        console.log("cargando tipo de evaluado");
        ...
        console.log("cargando tipo evaluado");
        ...
        console.log("cargando evaluacion");
        ...
        switch(parseInt(tipo_evaluado)){
            ...
            case 6:
             ...
             case 10:
                ...
                break;
             case 11:
                acceso.cargarselect('index.php?mod=sievas&controlador=evaluaciones&accion=get_evaluados','titulo','id','#evaluado', {
                    tipo_evaluado : 11,
                    pais : $('#pais').val()
                });
                break;
