...
<br/>
<strong>Calificación promedio del rubro: <?php 

if($evaluaciones_esp[$e_id] > 0 && $r['id'] == '12'){
            $calificacion_rubros += $rubro_calificaciones/($items_i-2); 
            echo $rubro_calificaciones/($items_i-2); 
        }
        else{
            $calificacion_rubros += $rubro_calificaciones/$items_i; 
            echo $rubro_calificaciones/$items_i;
        }
        ?> </strong>  <br/>
<?php 
$i++; 
