...
<div class="controls">
    ...
    <a href="index.php?mod=sievas&controlador=evaluar&accion=tablas_estadisticas_r" class="btn btn-default">Volver a tablas estadísticas</a>
</div>
<br/>
...
(Si ó No)</td>
  ...
  <div class="tabla_estadistica_r10_2_2_1_tpl hide"> 
    <div class="panel panel-default">
        <div class="panel-body">  
          <table class="table">
              <tr>
        ...
        <div class="panel-body">  
          <table class="table">
            <tr>
              ...
              <tr>
                  <td>Número de participantes satisfechos en la asignación de recursos de acuerdo a la planeación, programación, presupuestación, ejecución y evaluación de recursos financieros destinado al PE por rubro - Profesores</td>
                  <td class="campo_c"><input type="text" class="form-control"></td>
              </tr>
              <tr>
                  <td>Número de participantes satisfechos en la asignación de recursos de acuerdo a la planeación, programación, presupuestación, ejecución y evaluación de recursos financieros destinado al PE por rubro - Estudiantes</td>
                  <td class="campo_c"><input type="text" class="form-control"></td>
              </tr>
              <tr>
                  <td>Número de participantes satisfechos en la asignación de recursos de acuerdo a la planeación, programación, presupuestación, ejecución y evaluación de recursos financieros destinado al PE por rubro - Personal administrativo</td>
                  <td class="campo_c"><input type="text" class="form-control"></td>
              </tr>                  
          </table>
             <div class="form-controls pull-right">
